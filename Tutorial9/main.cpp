...
bool createUsingSize() {
    Week9::EuclideanVector vector(6);
...
bool createUsingVector() {
    ...
    Week9::EuclideanVector vector(first);
    return true;
}
...
bool createUsingCopyConstructor() {
    ...
    Week9::EuclideanVector v1(first);
    Week9::EuclideanVector v2(v1);
...
bool constAccessorTest() {
    ...
    const Week9::EuclideanVector v1(first);
    return (1.1 - v1[0]) < 0.11 && (2.1 - v1[1]) < 0.11 && (3.1 - v1[2]) < 0.11;
}
...
bool invalidAccessorTest1() {
    ...
    try {
        double x = v1[-1];
        return false && (bool)x;
    } catch (Week9::VectorIndexOutOfBoundsException e) {
        return std::string("Index is greater than or equal to the allocated size") ==
...
bool invalidAssignmentTest1() {
    ...
    Week9::EuclideanVector v2(50);

    try {
        v2 = v1;
    } catch (Week9::VectorAssignmentException e) {
...
// equality test
bool equalityTest() {
    Week9::EuclideanVector v1(4);
    v1[0] = 1 / 3.0;
    v1[1] = 2 / 3.0;
    v1[2] = 3 / 3.0;
    v1[3] = 4 / 3.0;

    Week9::EuclideanVector v2(4);
    v2[0] = 0.333;
    v2[1] = 0.666;
    v2[2] = 1.000;
    v2[3] = 1.333;
...
bool unitVectorTest() {
    ...
    Week9::EuclideanVector unitVector = v1.unitVector();

    return 0.34 > unitVector[0] && 0.32 < unitVector[0] && -0.67 < unitVector[1] && -0.65 > unitVector[1] &&
...
// addition test
bool additionTest() {
    Week9::EuclideanVector v1(2);
    v1[0] = 1;
    v1[1] = 0;

    Week9::EuclideanVector v2(2);
    v2[0] = 0;
    v2[1] = 1;

    Week9::EuclideanVector expected(2);
    expected[0] = 1;
    expected[1] = 1;

    Week9::EuclideanVector result = v1 + v2;
...
bool additionChainTest() {
    ...
    Week9::EuclideanVector v3(3);
    v3[0] = 0;
    v3[1] = 0;
    v3[2] = 1;

    Week9::EuclideanVector expected(3);
    expected[0] = 1;
    expected[1] = 1;
    expected[2] = 1;

    Week9::EuclideanVector result = v1 + v2 + v3;
...
bool subtractionChainTest() {
    ...
    Week9::EuclideanVector result = v1 - v2 - v3 - v4;
...
bool invalidMathamaticsTest() {
    ...
    try {
        Week9::EuclideanVector v3 = v1 + v2;
        return false && bool(v3.size());
    } catch (Week9::VectorArithmeticException e) {
    ...
    try {
        Week9::EuclideanVector v3 = v2 + v1;
        return false && bool(v3.size());
    } catch (Week9::VectorArithmeticException e) {
        if (std::string("Vectors are not the same size") == std::string(e.getMessage())) {
            ++numberOfExceptionsThrown;
    ...
    try {
        Week9::EuclideanVector v3(v1);
        Week9::EuclideanVector v4(v2);
