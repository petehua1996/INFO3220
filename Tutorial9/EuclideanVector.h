...
public:
    ...
    /**
     * @brief EuclideanVector move constructor to create a new vector from a temporary Euclidean vector
     * @param vector an existing temporary euclidean vector
     */
    EuclideanVector(const EuclideanVector&& vector);
